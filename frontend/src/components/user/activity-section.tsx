  ...
  return (
    <div className="border border-border/60 rounded-lg overflow-hidden bg-card/30 hover:bg-card/40 transition-colors">
      ...
      <button
        ...
        disabled={!hasDetails}
      >
        {/* Date — calendar bucket from the backend. parseApiDate builds the
            Date from local components so the "May 3" label stays stable in
            every timezone (see lib/utils/format.ts). */}
